...
if __name__ == '__main__':
    ...
    # /datav/jingwd/yolo_quantization/runs/train/no123detlre3/weights/qat_014.pt
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolo_quantization.yaml', help='model.yaml path')
